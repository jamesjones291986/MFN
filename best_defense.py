...
formations = {
    '113': {
        ...
        'run': ['Singleback Slot Strong HB Strong Inside']
    },
    '122': {
    ...
    '203': {
        'pass': ['I Formation 3WR Slot Short WR Deep'],
        'run': ['I Formation 3WR HB Inside Strong', 'Shotgun 2 RB 3 WR Shotgun Sweep']
    },
    '212': {
        'pass': ['Weak I Normal WR Corner TE Middle', 'Weak I Normal Skinny Posts', 'Strong I Normal Short Attack'],
        'run': ['I Formation Normal HB Blast']
    },
    '221': {
        'pass': ['Weak I Big WR Post TE Out'],
        'run': ['Weak I Big HB Dive Strong', 'Weak I Big HB Off Tackle Strong']
    },
    '311': {
    ...
    '104': {
        'pass': ['Empty 4 Wide Spread Flats'],
    },
    '105': {
